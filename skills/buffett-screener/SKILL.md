...
2. Run the screener:
```powershell
python "<PLUGIN_DIR>\skills\buffett-screener\scripts\screen_buffett.py" --universe "FPT,HPG,VNM"
```
3. Read the generated markdown report from `<PLUGIN_DIR>\reports\buffett_report.md` using the `view_file` tool.
