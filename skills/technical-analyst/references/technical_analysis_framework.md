...
- **Volatility Contraction Pattern (VCP)**: Decreasing price volatility and volume from left to right as a stock forms a base.

**Early VCP Signs (Vietnam Market Context):**
Even if a chart does not perfectly meet strict VCP criteria, you should identify early signs of contraction (e.g., a couple of narrowing swings, liquidity drying up at the bottom of the base). In such cases, explicitly note: "Cổ phiếu khả năng chuyển sang mô hình VCP" and explain this in the context of the Vietnam market (where T+2.5 settlement or higher baseline volatility may cause wider contraction ranges).
