...
```powershell
# Windows — Default: S&P 500, top 100 candidates
python skills/vcp-screener/scripts/screen_vcp.py --output-dir reports/

# Custom universe
python skills/vcp-screener/scripts/screen_vcp.py --universe AAPL NVDA MSFT AMZN META --output-dir reports/

# Full S&P 500 (paid API tier)
python skills/vcp-screener/scripts/screen_vcp.py --full-sp500 --output-dir reports/
```
...
```powershell
# Windows
python skills/vcp-screener/scripts/screen_vcp.py --strict --output-dir reports/
```
