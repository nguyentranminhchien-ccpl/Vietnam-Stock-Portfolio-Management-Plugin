...
1. **Chào mừng & Cài đặt tự động:** Chào mừng họ đến với hệ thống. Báo cho họ biết hệ thống cần các thư viện Python (`vnstock`, `rich`, `fpdf2`, `pandas`) và **đề nghị bạn (Agent) sẽ tự động chạy lệnh `pip install` để cài đặt thay họ**.
...
## 📄 Quy chuẩn đặt tên file báo cáo (Naming Convention)

| Loại báo cáo | Pattern tên file | Ví dụ |
|---|---|---|
| Phân tích cơ bản (auto) | `[TICKER.VN]_report.md` | `SHS.VN_report.md` |
| Phân tích kỹ thuật (AI) | `[TICKER.VN]_analysis_YYYYMMDD.md` | `SHS.VN_analysis_20260627.md` |
| Nghiên cứu đầu tư (AI) | `[TICKER.VN]_equity_research_YYYYMMDD.md` | `SHS.VN_equity_research_20260627.md` |
| Quét ngắn hạn | `[TICKER.VN]_st_scan_YYYYMMDD_HHMMSS.md` | `SHS.VN_st_scan_20260627_143022.md` |
| Đánh giá danh mục | `portfolio_review_YYYYMMDD.md` | `portfolio_review_20260627.md` |
| Báo cáo vĩ mô | `macro_report_YYYYMMDD.md` | `macro_report_20260627.md` |

> **Lưu ý:** Tất cả file AI-generated phải có **ngày** trong tên file. File không có ngày sẽ bị bỏ qua bởi PDF generator.
